// ************************************************************************************
// WEB524 Project Template V2 2221 == 1d6105ed-25e7-475c-840a-2d70341782ad
...
namespace W2022A5PGBNGUYEN.Controllers
{
    public class Manager
    {
        ...
        {
            var artists = ds.Artists.OrderBy(o => o.ArtistId);
        ...
        public ArtistWithDetailViewModels ArtistGetById(int? id)
        {
            ...
            else
            {
                ...
                return mapper.Map<Artist, ArtistWithDetailViewModels>(obj);
            }
        }
        ...
        public bool LoadData()
        {
            ...
            if (ds.Artists.Count() == 0)
            {
                ...
                {
                    Name = "Rakim Mayers",
                    BirthName = "A$AP Rocky",
                    BirthOrStartDate = new DateTime(1988, 5, 5),
                    Executive = user,
                    Genre = "Hip-Hop/Rap",
                    UrlArtist = "https://encrypted-tbn2.gstatic.com/images?q=tbn:ANd9GcRuxofEkudz-QOBAejWJYU8Qt4581d9Z2lIHd_zn9FXumtOpTAt"
                });
